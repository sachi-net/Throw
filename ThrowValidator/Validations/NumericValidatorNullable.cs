...
{
    /// <summary>
    ///  Define validations for nullable numeric structs.
    /// </summary>
    ...
    public class NumericValidatorNullable<T> : ValidationBase, INumericValidatable<T> where T: struct
    {
        ...
        /// <summary>
        /// Initialize <see cref="NumericValidatorNullable{T}"/> instance with value of type T (nullable) to perform validations.
        /// </summary>
        /// <param name="value">Numeric value of type T (nullable).</param>
        ...
        /// <summary>
        /// Initialize <see cref="NumericValidatorNullable{T}"/> instance with value of type T (nullable) to perform validations with custom <paramref name="message"/>.
        /// </summary>
        /// <param name="value">Numeric value of type T (nullable).</param>
        ...
        /// <summary>
        /// Initialize <see cref="NumericValidatorNullable{T}"/> instance with value of type T (nullable) to perform validations with custom <paramref name="exception"/>.
        /// </summary>
        /// <param name="value">Numeric value of type T (nullable).</param>
        ...
        /// <summary>
        /// Initialize <see cref="NumericValidatorNullable{T}"/> instance with value of type T (nullable) and <paramref name="action"/> to invoke when triggering validations.
        /// </summary>
        /// <param name="value">Numeric value of type T (nullable).</param>
